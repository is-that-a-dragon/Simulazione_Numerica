...
{    
  ...
  if(equilibrazione){
    ofstream Equil;
    Equil.open("equilibration_folder/gas_equil_test5.dat", ios::app);
    Equil << iblk << "," << stima_temp << "," << stima_pot << "," << stima_kin << endl;
    // block (or step) number number --- ith temp --- ith potential energy --- ith kinetic energy
    Equil.close();
  }
  else{
    ofstream Epot, Ekin, Etot, Temp, Press;
    Epot.open("data_folder/gas_epot.dat",ios::app);
    Ekin.open("data_folder/gas_ekin.dat",ios::app);
    Temp.open("data_folder/gas_temp.dat",ios::app);
    Etot.open("data_folder/gas_etot.dat",ios::app);
    Press.open("data_folder/gas_press.dat", ios::app);
